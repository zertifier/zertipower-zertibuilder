...
export class SmartContractsController {
  ...
  async get() {
    ...
    return HttpResponse.success('smart_contracts fetched successfully').withData(data);
  }
  ...
  async getById(@Param('id') id: string) {
    ...
    return HttpResponse.success('smart_contracts fetched successfully').withData(this.mapData(data));
  }
  ...
  async create(@Body() body: SaveSmartContractsDTO) {
    ...
    return HttpResponse.success('smart_contracts saved successfully').withData(data);
  }
  ...
  async update(@Param('id') id: string, @Body() body: SaveSmartContractsDTO) {
    ...
    return HttpResponse.success('smart_contracts updated successfully').withData(data);
  }
  ...
  async remove(@Param('id') id: string) {
    ...
    return HttpResponse.success('smart_contracts removed successfully').withData(data);
  }
