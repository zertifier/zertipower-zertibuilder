...
) ENGINE=InnoDB AUTO_INCREMENT=22501 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `energy_areas` (
  ...
  `location_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10121 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;
...
CREATE TABLE IF NOT EXISTS `energy_area_coordinates` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=117504 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;
...
CREATE TABLE IF NOT EXISTS `energy_registers` (
  ...
  KEY `info_dt` (`info_dt`),
  KEY `cups_id` (`cups_id`)
) ENGINE=InnoDB AUTO_INCREMENT=648528 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;
...
CREATE TABLE IF NOT EXISTS `energy_transactions` (
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=161044 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;
...
CREATE TABLE IF NOT EXISTS `inverter_energy_registers` (
  ...
  KEY `info_dt` (`info_dt`) USING BTREE,
  KEY `cups_id` (`cups_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=648102 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `logs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1951 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;
