...
export class EnergyRegistersController {
  ...
  async get() {
    ...
    return HttpResponse.success('energy_registers fetched successfully').withData(data);
  }
  ...
  async create(@Body() body: SaveEnergyRegistersDTO) {
    ...
    return HttpResponse.success('energy_registers saved successfully').withData(data);
  }
  ...
  async update(@Param('id') id: string, @Body() body: SaveEnergyRegistersDTO) {
    ...
    return HttpResponse.success('energy_registers updated successfully').withData(data);
  }
  ...
  async remove(@Param('id') id: string) {
    ...
    return HttpResponse.success('energy_registers removed successfully').withData(data);
  }

  @Post('datatable')
  @Auth(RESOURCE_NAME)
  async datatables(@Body() body: any) {
    const data = await this.datatable.getData(body, `SELECT id,info_dt,cups_id,import,consumption,export,generation,created_at,updated_at
