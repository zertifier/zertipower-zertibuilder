...
export class EnergyTransactionsController {
  ...
  async get() {
    ...
    return HttpResponse.success('energy_transactions fetched successfully').withData(data);
  }
  ...
  async getById(@Param('id') id: string) {
    ...
    return HttpResponse.success('energy_transactions fetched successfully').withData(this.mapData(data));
  }
  ...
  async create(@Body() body: SaveEnergyTransactionsDTO) {
    ...
    return HttpResponse.success('energy_transactions saved successfully').withData(data);
  }

  @Put(':id')
  @Auth(RESOURCE_NAME)
  async update(@Param('id') id: string, @Body() body: SaveEnergyTransactionsDTO) {
    ...
    return HttpResponse.success('energy_transactions updated successfully').withData(data);
  }
  ...
  async remove(@Param('id') id: string) {
    ...
    return HttpResponse.success('energy_transactions removed successfully').withData(data);
  }

  @Post('datatable')
  @Auth(RESOURCE_NAME)
  async datatables(@Body() body: any) {
    const data = await this.datatable.getData(body, `SELECT id,cups_id,info_dt,kwh_in,kwh_out,kwh_surplus,block_id,created_at,updated_at
